...
client.login(email="da496803@gmail.com",password="kaifsahil222@@@")
...
admx=["http://aminoapps.com/p/eyrvs0"]
...
def on_group_member_leave(data):
	if data.comId==cidy:
		try:
			subclient.send_message(chatId=data.message.chatId,message="""[b][BC]━━━━┅━━━┅━━━━
[C]「 OH NOO !! 」
